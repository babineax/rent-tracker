  ...
  const mockRequests = [
    {
      ...
      tenant: { name: "John Doe", phone: "+254700123456" },
      property: { name: "Sunset Apartments", address: "Westlands, Nairobi" },
      unit: { unit_number: "A1" }
    },
    {
      id: 2,
      title: "Electrical Outlet Not Working",
      description: "The electrical outlet in the living room is not working. No power when plugging in devices.",
      category: "electrical",
      priority: "high",
      status: "acknowledged",
      created_at: "2024-01-14T14:20:00Z",
      tenant: { name: "Jane Smith", phone: "+254700789012" },
      property: { name: "Green Valley", address: "Kilimani, Nairobi" },
      unit: { unit_number: "B3" }
    },
    {
      id: 3,
      title: "AC Unit Not Cooling",
      description: "The air conditioning unit is running but not cooling the room properly.",
      category: "hvac",
      priority: "high",
      status: "in_progress",
      created_at: "2024-01-13T09:15:00Z",
      tenant: { name: "Mike Johnson", phone: "+254700345678" },
      property: { name: "Riverside Heights", address: "Lavington, Nairobi" },
      unit: { unit_number: "C2" }
    }
  ];
